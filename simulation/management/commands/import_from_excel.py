...
class Command(BaseCommand):
    ...
    def _create_shift_configurations(self):
        ...
        configs_data = [
            ...
            # Example configurations with cleaning time
            {'name': '3x8 SS 5d 6h', 'shifts_per_day': 3, 'hours_per_shift': 8, 'days_per_week': 5,
             'includes_saturday': True, 'includes_sunday': True,
             'saturday_hours': 16, 'sunday_hours': 8, 'opening_cleaning_time': 6,
             'description': '3 shifts of 8 hours, 5 days + weekend hours, 6h cleaning'},
        ]
